...
//myBtn.addEventListener("click", async function getData(){

   // let currentW = await fetchData('http://api.apixu.com/v1/forecast.json?key=0dd543a8039545aca6594651182202&q=Stockholm,Sweden&days=6');
